...
public class ChatViewBeanDao extends AbstractDao<ChatViewBean, String> {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T5", daoSession.getChatFriendBeanDao().getAllColumns());
            ...
            builder.append(" LEFT JOIN CHAT_FRIEND_BEAN T4 ON T.\"FID\"=T4.\"UID\"");
            builder.append(" LEFT JOIN CHAT_FRIEND_BEAN T5 ON T.\"UID\"=T5.\"UID\"");
            builder.append(' ');
    ...
    protected ChatViewBean loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        ChatFriendBean uUser = loadCurrentOther(daoSession.getChatFriendBeanDao(), cursor, offset);
