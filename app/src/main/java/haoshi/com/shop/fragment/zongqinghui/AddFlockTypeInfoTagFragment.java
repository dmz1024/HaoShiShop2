...
import haoshi.com.shop.adapter.AddFlockTypeInfoTagAdapter;
...
public class AddFlockTypeInfoTagFragment extends ListNetWorkBaseFragment<PerfectRegInfoTagBean> {

    @Override
    protected RecyclerView.Adapter getAdapter() {
        return new AddFlockTypeInfoTagAdapter(getContext(), (ArrayList<PerfectRegInfoTagBean.Data>) totalList);
    }
    ...
    public void choose() {
        ...
        RxBus.get().post("addFragment", new AddFragmentBean(AddFlockTypeWriteInfoRootFragment.getInstance(sb.toString())));
    }
