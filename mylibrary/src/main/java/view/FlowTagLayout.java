...
public class FlowTagLayout extends ViewGroup {
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (getChooseArray().size() >= MAX) {
                                MyToast.showToast("最多选择" + MAX + "项");
                            } else {
                                mCheckedTagArray.put(j, true);
                                childView.setSelected(true);
                            }
    ...
    public ArrayList<Integer> getChooseArray() {
    ...
    private OnMoreChooseInterface onMoreChooseInterface;

    public void setOnMoreChooseInterface(OnMoreChooseInterface onMoreChooseInterface) {
        this.onMoreChooseInterface = onMoreChooseInterface;
    }

    public interface OnMoreChooseInterface {
        boolean choose(int size);
    }
